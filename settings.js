...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=LmJCgKoB#0Q5-J1tGGjYbvNSEVENqdYS3fRmfngWz4KxdUn4HiSk' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello සුබ දවසක් , Lankesh alive now!!*" : process.env.ALIVE_MSG,
